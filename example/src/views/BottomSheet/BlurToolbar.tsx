...
// import Animated, { debug, interpolateNode, Extrapolate, max, multiply, add } from 'react-native-reanimated'
...
//     fullScreenHeight = Dimensions.get('screen').height - (StatusBar.currentHeight as number) - this.titleHeight;
...
//     renderHeader = () => {
//         let opacity = interpolateNode(this.fall, {
//             inputRange: [0, this.secScreenPoint, 1],
//             outputRange: [1, 1, 0],
//             extrapolate: Extrapolate.CLAMP
//         })

//         let translateY = interpolateNode(this.fall, {
//             inputRange: [0, this.secScreenPoint, 1],
...
//         let titleTranslateY = interpolateNode(this.fall, {
//             inputRange: [breakPoint, this.secScreenPoint, 1],
//             outputRange: [0, needY, needY],
//             extrapolate: Extrapolate.CLAMP
//         })

//         let titleTranslateX = interpolateNode(this.fall, {
//             inputRange: [breakPoint, this.secScreenPoint, 1],
//             outputRange: [0, -100, -100],
//             extrapolate: Extrapolate.CLAMP
//         })

//         let titleScale = interpolateNode(this.fall, {
//             inputRange: [breakPoint, this.secScreenPoint, 1],
...
//                             zIndex: 2000,
//                             opacity: opacity,
//                             transform: [{ translateX: titleTranslateX }, { translateY: titleTranslateY }, { scale: titleScale }] as any,
//                         }
//                     ]}
...
//         let imageOpacity = interpolateNode(this.fall, {
//             inputRange: [0, this.secScreenPoint, 1],
//             outputRange: [0, 0, 1],
//             extrapolate: Extrapolate.CLAMP
//         })
...
//                                     transform: [{ scale: max(1, multiply(this.fall, 0.8)) }] as any,
//                                 }
//                             ]
